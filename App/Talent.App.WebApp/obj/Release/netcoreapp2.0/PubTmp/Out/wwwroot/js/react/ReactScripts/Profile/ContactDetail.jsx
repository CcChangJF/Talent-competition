...
export class IndividualDetailSection extends Component {
    ...
    renderDisplay() {
        //let fullName = this.state.newContact.firstName
        //    + ' ' + this.state.newContact.lastName;
        //let email = this.state.newContact.email;
        //let phone = this.state.newContact.phone;
        let fullName = this.props.details ?
            `${this.props.details.firstName ? this.props.details.firstName : ""} ${this.props.details.lastName ? this.props.details.lastName : ""}` : ""
